...
public interface SharedConstants {
	String CONTENT_STYLE_SUPPORTED = "android.media.browse.CONTENT_STYLE_SUPPORTED";
	String CONTENT_STYLE_PLAYABLE_HINT = "android.media.browse.CONTENT_STYLE_PLAYABLE_HINT";
	String CONTENT_STYLE_BROWSABLE_HINT = "android.media.browse.CONTENT_STYLE_BROWSABLE_HINT";
	int CONTENT_STYLE_LIST_ITEM_HINT_VALUE = 1;

	String CUSTOM_ACTION_RW = "me.aap.fermata.action.rewind";
